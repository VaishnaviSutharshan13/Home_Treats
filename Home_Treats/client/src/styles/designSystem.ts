...
export const designSystem = {
  ...
  // Cards
  card: {
    base: 'rounded-xl shadow-md bg-white/5 backdrop-blur-sm border border-green-500/10',
    padding: 'p-6',
    hover: 'hover:shadow-lg hover:border-green-500/20 transition-all duration-300',
  ...
  button: {
    ...
    primary: {
      base: 'bg-green-500 text-white hover:bg-green-600 focus:ring-green-500 shadow-sm shadow-green-500/20',
      hover: 'hover:shadow-md hover:shadow-green-500/30 hover:scale-105 transform',
    },
    secondary: {
      base: 'bg-white/5 backdrop-blur-sm text-white border border-green-500/20 hover:bg-green-500/10 focus:ring-green-500',
      hover: 'hover:shadow-md hover:border-green-500/30',
    },
    outline: {
      base: 'border border-green-500/50 text-green-400 hover:bg-green-500/10 focus:ring-green-500',
      hover: 'hover:border-green-400 hover:text-green-300',
    },
    ghost: {
      base: 'text-gray-400 hover:text-white hover:bg-white/5 focus:ring-green-500',
  ...
  form: {
    input: {
      ...
      focus: 'focus:border-green-500 focus:ring-1 focus:ring-green-500 focus:outline-none',
    ...
    checkbox: {
      base: 'h-4 w-4 rounded border-white/10 text-green-500 focus:ring-green-500 bg-white/5',
    },
    radio: {
      base: 'h-4 w-4 border-white/10 text-green-500 focus:ring-green-500 bg-white/5',
    },
  },
  ...
  // Navigation
  nav: {
    base: 'bg-[#0f172a]/90 backdrop-blur-md shadow-sm border-b border-green-500/10',
