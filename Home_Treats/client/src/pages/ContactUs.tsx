...
const ContactUs = () => {
  ...
  const socialLinks = [
    ...
    { icon: <FaWhatsapp className="w-5 h-5" />, href: '#', label: 'WhatsApp', color: 'hover:bg-green-600' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      General: <a href="mailto:sivananthangowsikan2003@gmail.com" className="hover:text-green-400 transition-colors">sivananthangowsikan2003@gmail.com</a><br />
                      Support: <a href="mailto:support@hometreats.lk" className="hover:text-green-400 transition-colors">support@hometreats.lk</a><br />
                      Bookings: <a href="mailto:gowsileo@gmail.com" className="hover:text-green-400 transition-colors">gowsileo@gmail.com</a>
                    </p>
                  </div>
                </div>
            ...
            {/* Google Map */}
            <div className="card overflow-hidden p-0 border border-green-500/10">
              <iframe
            ...
            <div className="card">
              ...
              <p className="text-gray-400 mb-6">Stay connected through our social media channels</p>
              <div className="flex flex-wrap gap-3">
                {socialLinks.map((link, i) => (
                  <a
                    ...
                    className={`w-12 h-12 bg-white/5 border border-green-500/10 rounded-xl flex items-center justify-center text-gray-400 hover:text-white ${link.color} transition-all duration-300 hover:shadow-lg hover:scale-110`}
                  >
                    {link.icon}
                  </a>
                ))}
