      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full text-white p-12">
          <div className="text-center">
            <div className="w-20 h-20 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-8 border border-green-500/20">
              <FaUserPlus className="w-10 h-10 text-green-400" />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Join <span className="text-green-400">Home_Treats</span>
            </h1>
            ...
            <div className="space-y-3 text-left max-w-sm mx-auto">
              {[
                ...
                <div key={i} className="flex items-center space-x-3 text-green-100">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-green-500/10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">Join our community and find your perfect room</p>
            </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-3 bg-white/5 backdrop-blur border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-300 ${
                      errors.fullName ? 'border-red-500 focus:ring-red-500 bg-red-500/10' : 'border-white/10 hover:border-white/20'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-12 pr-4 py-3 bg-white/5 backdrop-blur border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-300 ${
                      errors.email ? 'border-red-500 focus:ring-red-500 bg-red-500/10' : 'border-white/10 hover:border-white/20'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-12 pr-4 py-3 bg-white/5 backdrop-blur border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-300 ${
                      errors.phone ? 'border-red-500 focus:ring-red-500 bg-red-500/10' : 'border-white/10 hover:border-white/20'
                    }`}
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-12 py-3 bg-white/5 backdrop-blur border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-300 ${
                      errors.password ? 'border-red-500 focus:ring-red-500 bg-red-500/10' : 'border-white/10 hover:border-white/20'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-12 pr-12 py-3 bg-white/5 backdrop-blur border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-300 ${
                      errors.confirmPassword ? 'border-red-500 focus:ring-red-500 bg-red-500/10' : 'border-white/10 hover:border-white/20'
                    }`}
