...
const ActivityLog = () => {
  ...
  const getTargetIcon = (type: string) => {
    switch (type) {
      case 'student': return <FaUsers className="w-3.5 h-3.5 text-blue-600" />;
      case 'room': return <FaBed className="w-3.5 h-3.5 text-emerald-600" />;
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <FaCalendarAlt className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-gray-400" />
                  <input
                    type="date"
                    value={startDate}
            ...
            {hasActiveFilters && (
              <div className="mt-4 flex items-center gap-2">
                ...
                <span className="text-xs text-gray-400">{pagination.total} result{pagination.total !== 1 ? 's' : ''} found</span>
              </div>
            )}
          </div>
              ...
              <div className="flex items-center justify-center py-20">
                <div className="text-center">
                  ...
                  <button
                    ...
                    className="mt-3 px-4 py-1.5 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 transition"
                  >
                    Retry
                  </button>
                </div>
                        ...
                        <tr key={log._id} className="hover:bg-gray-50/50 transition-colors">
                          <td className="px-5 py-3.5">
                            <div className="flex items-center gap-2.5">
                              ...
                              <span className="text-sm font-medium text-gray-900 truncate max-w-[140px]">{log.adminName}</span>
                            </div>
                          </td>
                          <td className="px-5 py-3.5">
                  ...
                  {logs.map((log) => (
                    <div key={log._id} className="p-4 hover:bg-gray-50 transition-colors">
                      <div className="flex items-start gap-3">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-xs font-semibold flex-shrink-0 mt-0.5">
                          {log.adminName.split('@')[0].slice(0, 2).toUpperCase()}
                        </div>
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-400 mt-1.5">{formatDateTime(log.timestamp)}</p>
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              <div className="flex items-center justify-between px-5 py-3 border-t border-gray-100 bg-gray-50">
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="p-2 rounded-lg text-gray-500 hover:bg-white hover:shadow-sm transition disabled:opacity-30 disabled:cursor-not-allowed"
                  >
