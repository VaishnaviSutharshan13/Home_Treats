...
import { FaHome, FaPlus, FaEdit, FaTrash, FaSearch, FaUser, FaEnvelope, FaPhone, FaCheck, FaTimes, FaSpinner, FaEye } from 'react-icons/fa';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Link to="/admin/dashboard" className="flex items-center text-gray-600 hover:text-gray-900">
                <FaHome className="w-5 h-5 mr-2" />
                Back to Dashboard
              </Link>
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Student Management</h1>
                <p className="text-sm text-gray-600">Manage hostel students and information</p>
              </div>
            </div>
            <button
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{viewingStudent.phone}</p>
                </div>
                <div>
                  <p className="text-gray-500 font-medium">Room</p>
                  <p className="text-gray-900">{viewingStudent.room}</p>
                </div>
                <div>
                  <p className="text-gray-500 font-medium">Status</p>
                  <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${viewingStudent.status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                    {viewingStudent.status}
                  </span>
                </div>
                <div>
                  <p className="text-gray-500 font-medium">Course</p>
                  <p className="text-gray-900">{viewingStudent.course}</p>
                </div>
                <div>
                  <p className="text-gray-500 font-medium">Year</p>
                  <p className="text-gray-900">{viewingStudent.year}</p>
                </div>
                <div>
                  <p className="text-gray-500 font-medium">Fees Status</p>
                  <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${viewingStudent.fees === 'Paid' ? 'bg-green-100 text-green-800' : viewingStudent.fees === 'Pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'}`}>
                    {viewingStudent.fees}
                  </span>
                </div>
                <div>
                  <p className="text-gray-500 font-medium">Join Date</p>
                  <p className="text-gray-900">{viewingStudent.joinDate ? new Date(viewingStudent.joinDate).toLocaleDateString() : 'N/A'}</p>
                </div>
              </div>
