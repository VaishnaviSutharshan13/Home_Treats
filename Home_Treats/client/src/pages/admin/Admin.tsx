...
const Admin = () => {
  ...
  const [recentActivities, setRecentActivities] = useState([
    { id: 1, type: 'student', action: 'New student registered', time: '2 mins ago', icon: <FaUsers className="text-blue-500" /> },
    { id: 2, type: 'room', action: 'Room A-201 allocated', time: '5 mins ago', icon: <FaBed className="text-green-500" /> },
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-blue-200">Complete system management and control</p>
            </div>
            <div className="flex items-center space-x-4">
              <button className="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-800 transition-colors duration-300 flex items-center">
                <FaCog className="mr-2" />
                Settings
              </button>
              <button className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors duration-300 flex items-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {quickActions.map((action) => (
                  <Link
                    key={action.id}
                    to={action.link}
                    className={`bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105 block`}
                  >
                  ...
                  <div key={activity.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                    <div className="flex items-center">
                      <div className={`p-2 rounded-full mr-4 ${
                        ...
                        activity.type === 'room' ? 'bg-green-100' :
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                <button className="w-full text-left bg-blue-600 text-white px-4 py-3 rounded-lg hover:bg-blue-700 transition-colors duration-300 flex items-center">
                  <FaPlus className="mr-3" />
                  Backup Database
                </button>
                <button className="w-full text-left bg-green-600 text-white px-4 py-3 rounded-lg hover:bg-green-700 transition-colors duration-300 flex items-center">
                  <FaPlus className="mr-3" />
                  Restore Database
                </button>
                <button className="w-full text-left bg-orange-600 text-white px-4 py-3 rounded-lg hover:bg-orange-700 transition-colors duration-300 flex items-center">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full text-left bg-indigo-600 text-white px-4 py-3 rounded-lg hover:bg-indigo-700 transition-colors duration-300 flex items-center">
                  <FaCog className="mr-3" />
                  User Permissions
                </button>
                <button className="w-full text-left bg-pink-600 text-white px-4 py-3 rounded-lg hover:bg-pink-700 transition-colors duration-300 flex items-center">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                <button className="w-full text-left bg-gray-600 text-white px-4 py-3 rounded-lg hover:bg-gray-700 transition-colors duration-300 flex items-center">
                  <FaCog className="mr-3" />
                  General Settings
                </button>
                <button className="w-full text-left bg-red-600 text-white px-4 py-3 rounded-lg hover:bg-red-700 transition-colors duration-300 flex items-center">
                  <FaCog className="mr-3" />
                  Security Settings
                </button>
                <button className="w-full text-left bg-yellow-600 text-white px-4 py-3 rounded-lg hover:bg-yellow-700 transition-colors duration-300 flex items-center">
                  <FaCog className="mr-3" />
                  Email Configuration
                </button>
              </div>
