...
import { FaHome, FaPlus, FaEdit, FaSearch, FaFilter, FaExclamationTriangle, FaCheckCircle, FaClock, FaTimesCircle, FaSpinner, FaComment, FaEye, FaTrash } from 'react-icons/fa';
...
const ComplaintManagement = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Toast */}
      {toast && (
        <div className={`fixed top-6 right-6 z-50 px-5 py-3 rounded-lg shadow-lg text-white text-sm font-medium transition-all duration-300 ${toast.type === 'success' ? 'bg-green-600' : 'bg-red-600'}`}>
          {toast.message}
        </div>
      )}
      ...
      {assignModalOpen && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Assign Complaint</h3>
            ...
            />
            <label className="block text-sm font-medium text-gray-700 mb-1">Estimated Resolution (optional)</label>
            <input
              type="date"
      ...
      {rejectModalOpen && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Reject Complaint</h3>
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                className="px-5 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-50 transition-colors flex items-center"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-blue-200">Handle student complaints and maintenance requests</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-4">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <button
              ...
              className="flex items-center justify-center bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-300"
            >
          ...
          {!loading && !error && filteredComplaints.length > 0 && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {filteredComplaints.map((complaint) => (
                <div key={complaint._id} className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
                  <div className="p-6">
                    {/* Complaint Header */}
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex-1">
                        <div className="flex items-center mb-2">
                          ...
                          <h3 className="text-lg font-semibold text-gray-900 ml-2">{complaint.title}</h3>
                        </div>
                    ...
                    <div className="border-t pt-4">
                      ...
                      {complaint.status === 'Resolved' && complaint.resolvedDate && (
                        <div className="mb-4">
                          ...
                          <p className="text-sm font-medium text-green-600">{formatDate(complaint.resolvedDate)}</p>
                        </div>
                      )}
                      ...
                      <div className="border-t pt-3 mb-3 space-y-2">
                        ...
                        <div className="flex justify-end space-x-2">
                          ...
                          <button
                            ...
                            className="px-4 py-1 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 flex items-center"
                          >
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="bg-emerald-50 text-emerald-600 px-3 py-2 rounded-lg hover:bg-emerald-100 transition-colors duration-300 flex items-center justify-center"
                        title="View Details"
                      >
                      ...
                      {complaint.status === 'Pending' && (
                        <button
                          ...
                          className="flex-1 bg-green-600 text-white px-3 py-2 rounded-lg hover:bg-green-700 disabled:opacity-50 transition-colors duration-300 flex items-center justify-center"
                        >
                      ...
                      {complaint.status === 'In Progress' && (
                        <>
                          ...
                          <button
                            ...
                            disabled={actionLoading === complaint._id}
                            className="flex-1 bg-red-600 text-white px-3 py-2 rounded-lg hover:bg-red-700 disabled:opacity-50 transition-colors duration-300 flex items-center justify-center"
                          >
                      ...
                      {(complaint.status === 'Resolved' || complaint.status === 'Rejected') && commentFormOpen !== complaint._id && (
                        <button
                          ...
                          className="flex-1 bg-blue-600 text-white px-3 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-300 flex items-center justify-center"
                        >
                          <FaComment className="mr-1" />
                          Comment
                        </button>
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 ml-2">{viewingComplaint.title}</h3>
                </div>
                <div className="flex space-x-2">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm border-t pt-4">
                <div>
                  ...
                  <p className="text-gray-900">{viewingComplaint.student}</p>
                </div>
                <div>
                  <p className="text-gray-500 font-medium">Room</p>
                  <p className="text-gray-900">{viewingComplaint.room}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{formatDate(viewingComplaint.estimatedResolution)}</p>
                </div>
                {viewingComplaint.resolvedDate && (
                  <div className="col-span-2">
                    <p className="text-gray-500 font-medium">Resolved On</p>
                    <p className="text-green-600 font-medium">{formatDate(viewingComplaint.resolvedDate)}</p>
                  </div>
                )}
              ...
              <div className="flex justify-end space-x-3 pt-4 border-t">
                <button onClick={() => setViewingComplaint(null)} className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">Close</button>
              </div>
            </div>
          </div>
        </div>
