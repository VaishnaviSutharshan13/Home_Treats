        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <button onClick={fetchRoom} className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
                Retry
              </button>
            </div>
          ) : !room ? (
            <div className="text-center py-20">
              ...
              <p className="text-gray-400">Contact the hostel administration to get a room assigned.</p>
            </div>
          ) : (
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border p-6 text-center">
                  ...
                  <p className="text-xl font-bold text-green-600 mt-1">{formatLKR(room.price)}</p>
                </div>
              </div>
