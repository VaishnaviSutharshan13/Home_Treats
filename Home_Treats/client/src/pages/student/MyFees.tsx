        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <button onClick={fetchFees} className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">Retry</button>
            </div>
          ) : (
                ...
                <div className="bg-white rounded-xl shadow-sm border p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-green-600">{formatLKR(totalPaid)}</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white rounded-xl shadow-sm border p-6">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 p-6">
              <div className="text-center mb-6">
                <FaReceipt className="w-10 h-10 text-green-600 mx-auto mb-2" />
              ...
              <div className="space-y-3 border-t border-b py-4 mb-4">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-green-600">{receipt.currency} {receipt.amount.toLocaleString()}</span>
                </div>
                <div className="flex justify-between text-sm">
